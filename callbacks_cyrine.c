...
on_Pointage_clicked                    (GtkWidget       *objet,
                                        gpointer         user_data)
{
GtkWidget *Pointage, *liste_des_ouvriers;
	liste_des_ouvriers=lookup_widget(objet, "liste_des_ouvriers");
...
on_Modifier_ouvrier_clicked            (GtkWidget       *objet,
                                        gpointer         user_data)
{
GtkWidget *liste_des_ouvrier, *modifier;
...
void
on_Rechercher_ouvrier_clicked          (GtkWidget       *objet_graphique,
                                        gpointer         user_data)
{
ouvrier o ;
int r;
...
strcpy(texte,gtk_entry_get_text(GTK_ENTRY(CIN_rech)));
...
void
on_Supprimer_modification_clicked      (GtkWidget       *objet,
                                        gpointer         user_data)
{
GtkWidget *modifier, *alerte;
	modifier=lookup_widget(objet, "modifier");
...
void
on_Okalerte_clicked                    (GtkWidget       *objet_graphique,
                                        gpointer         user_data)
{
GtkWidget *input1;
GtkWidget *output1;           
	...
	char resultat[50];
 	...
 	input1=lookup_widget (objet_graphique,"CIN_rech");          
 	output1 = lookup_widget(objet_graphique, "label21");

	strcpy (resultat,"cet ouvrier n'existe pas ");
